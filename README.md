...
- The Phone Count header column will return the number of phones active in the specified year per employee. Phones that were deactivated prior to the report year, or activated afterward are not included.
